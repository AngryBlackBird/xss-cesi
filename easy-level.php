    ...
    <main class="mdl-layout__content">
        <section class="mdl-layout__tab-panel is-active" id="fixed-tab-1">
            <div class="page-content">
                <center>
                    <form action="easy-level.php" method="POST">
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" name="pseudo" type="text" id="pseudo">
                            <label class="mdl-textfield__label" for="pseudo">Pseudo</label>
                        </div>
                        <br>
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" name="mdp" type="password" id="mdp">
